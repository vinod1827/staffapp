package com.kleverowl.staffapp.components.numberpicker;
...
import com.kleverowl.staffapp.components.numberpicker.Listener.*;
...
public class NumberPicker extends LinearLayout {
    ...
    private RelativeLayout decrementButton;
    private RelativeLayout incrementButton;
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        // init ui components
        this.decrementButton = (RelativeLayout) findViewById(R.id.decrement);
        this.incrementButton = (RelativeLayout) findViewById(R.id.increment);
